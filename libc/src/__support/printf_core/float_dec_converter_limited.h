...
LIBC_INLINE int convert_float_inner(WriterT *writer,
...
LIBC_INLINE int
convert_float_typed(WriterT *writer, const BasicFormatSection<CharT> &to_conv,
...
template <typename WriterT, typename CharT>
LIBC_INLINE int convert_float_outer(WriterT *writer,
                                    const BasicFormatSection<CharT> &to_conv,
                                    ConversionType ctype) {
